 ...
 */
export type AndesAddedServices = {
    validation: {
        AndesValidator: AndesValidator
    }
}
 ...
 */
export type AndesServices = LangiumServices & AndesAddedServices
 ...
 */
export function createAndesServices(context: DefaultSharedModuleContext): {
    shared: LangiumSharedServices,
    Andes: AndesServices
} {
    const shared = inject(
        createDefaultSharedModule(context),
        AndesGeneratedSharedModule
    );
    const Andes = inject(
        createDefaultModule({ shared }),
        AndesGeneratedModule,
        AndesModule
    );
    shared.ServiceRegistry.register(Andes);
    registerValidationChecks(Andes);
